...
public class StringUtil {
     ...
     * @return
     */
    public static String Q2B(String QJstr) throws UnsupportedEncodingException{
        String outStr = "";
        String Tstr = "";
        byte[] b = null;
    ...
    /**
     * 
     * 标题: stringToHtmlcode <br />
     * 描述: html转义 
     * @param str
     * @return
     */
    public static String htmlToHtmlcode(String str){
    	str = str.replaceAll("&", "&amp;");
    	str = str.replaceAll("<", "&lt;");
    	str = str.replaceAll(">", "&gt;");
    	str = str.replaceAll("\"", "&quot;");
    ...
    public static String buildString(Object... strings){
    	StringBuilder sb = new StringBuilder();
    	for(Object tmp : strings) sb.append(tmp == null ? "null" : tmp.toString());
    	return sb.toString();
    }
}